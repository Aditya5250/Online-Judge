...
import { createProblem, getAllProblems, getProblemBySlug, updateProblem, deleteProblem, getAllProblemsForAdmin } from "../controllers/problem.controller.js";
...
router.get("/admin", authMiddleware, authorizeRoles("ADMIN"), getAllProblemsForAdmin);
